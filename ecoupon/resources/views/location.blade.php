          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Area Location</h3>
				  ...
				  <div class="row">
					<div class="col-sm-6">
                      <!-- select -->
                        ...
                        <label>Add Area Location</label>
                        	@if(session()->has('sumsg'))
							 <span class="text-success font-weight-bold ml-5" id="sumsg">{{session()->get('sumsg')}}</span>
							@endif

                        <input class="form-control" type="text" rows="3" name="location" placeholder="Enter Area"/>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-center">
						  <a class="btn btn-danger btn-sm"  href="javascript:;" onclick="confirmDelete('{{$location->id}}')">
                              <i class="fas fa-trash-alt">
                              </i>
                              Delete
                          </a>
                           <form id="delete-user-{{$location->id}}" action="{{ route('deleteLocation', $location->id ) }}" method="POST" style="display: none;">
        @csrf
      </form>
